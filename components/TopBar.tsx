                ...
                <div className="flex flex-col justify-center items-center gap-12 py-10">
                  <NavigationMenu>
                    <NavigationMenuList className="gap-4 flex-col">
                      ...
                      <NavigationMenuItem className="text-green-700 font-bold hover:bg-green-700 py-2 px-3 transition-all duration-500 rounded-md hover:text-white text-sm hover:font-semibold">
